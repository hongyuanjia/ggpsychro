...
The style of the saturation line can be changed using ggplot2 theme elements.
...
ggpsychro renders psychrometric reference grids in `coord_psychro()`. It also
provides thin ggplot-style helpers to control those grids explicitly:
...
layers; they mark grids as visible or hidden and optionally override line style.

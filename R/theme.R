    ...
    ggplot2::theme_grey(
        ...
        ggplot2::theme(
            ...
            panel.grid.major.x = ggplot2::element_line(
                color = grDevices::rgb(0.855, 0.145, 0.114, 1.0),
                linetype = 3,
                linewidth = 0.15
            ),
            ...
            panel.grid.major.y = ggplot2::element_line(
                color = grDevices::rgb(0.0, 0.125, 0.376, 1.0),
                linetype = 3,
                linewidth = 0.15
            ),
            ...
            psychro.panel.grid.saturation = ggplot2::element_line(
                color = grDevices::rgb(0.855, 0.145, 0.114),
                linewidth = 1
            ),
            psychro.panel.grid.relhum = ggplot2::element_line(
                color = grDevices::rgb(0.0, 0.498, 1.0, 1.0),
                linewidth = 0.4,
                linetype = "dotdash"
            ),
            psychro.panel.grid.wetbulb = ggplot2::element_line(
                color = grDevices::rgb(0.498, 0.875, 1.0, 1.0),
                linewidth = 0.2
            ),
            ...
            psychro.panel.grid.specvol = ggplot2::element_line(
                color = grDevices::rgb(0.0, 0.502, 0.337, 1.0),
                linewidth = 0.2,
                linetype = "longdash"
            ),
            psychro.panel.grid.enthalpy = ggplot2::element_line(
                color = grDevices::rgb(0.251, 0.0, 0.502, 1.0),
                linewidth = 0.2
            ),
...
theme_psychro_minimal <- function(
    ...
    ggplot2::theme_grey(
        ...
        ggplot2::theme(
            ...
            psychro.panel.grid.minor.relhum = ggplot2::element_blank(),
            psychro.panel.grid.wetbulb = ggplot2::element_line(
                color = grDevices::rgb(0.498, 0.875, 1),
                linewidth = 0.25,
                linetype = "solid"
            ),
            psychro.panel.grid.major.wetbulb = ggplot2::element_line(
            ...
            psychro.panel.grid.minor.vappres = ggplot2::element_blank(),
            psychro.panel.grid.specvol = ggplot2::element_line(
                color = grDevices::rgb(0, 0.502, 0.337),
                linewidth = 0.5,
                linetype = "solid"
            ),
            psychro.panel.grid.major.specvol = ggplot2::element_line(
            ...
            psychro.panel.grid.enthalpy = ggplot2::element_line(
                color = grDevices::rgb(0.251, 0, 0.502),
                linewidth = 0.5,
                linetype = "solid"
            ),
            psychro.panel.grid.major.enthalpy = ggplot2::element_line(

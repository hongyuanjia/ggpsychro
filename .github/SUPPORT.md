# Getting help with ggpsychro

Thanks for using ggpsychro. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ggpsychro/issues) to make sure the 

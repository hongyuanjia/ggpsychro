...
Givoni overlays are strategy zones rather than a single continuous comfort
metric. Create a strategy with `comfort_strategy_givoni()` and draw it with
`geom_comfort_givoni()`. The mean outdoor temperature shifts the strategy
geometry and is shown on the chart as a dashed marker.

```{r givoni-zones, fig.alt = "Psychrometric chart with Givoni bioclimatic strategy zones and a mean outdoor temperature marker."}

...
- Aligned adaptive comfort filled bands with the analytic adaptive
  comfort zone boundary so Mollier overlays do not mix grid-interpolated
  and analytic geometry.
  ([\#40](https://github.com/hongyuanjia/ggpsychro/issues/40))
...
- Refined comfort overlay APIs and documentation, added Givoni-Milne
  strategy variants with custom comfort anchors, and added CI-only
  ggplot2 compatibility checks.
  ([\#37](https://github.com/hongyuanjia/ggpsychro/issues/37))
...
- Streamlined comfort, grid, coordinate, and stat internals; renamed the
  ...
  ([\#35](https://github.com/hongyuanjia/ggpsychro/issues/35))
...
- Added optional inline contour labels to comfort overlays.
...
- Added thermal comfort calculations and comfort overlay layers for
  PMV/PPD, SET, adaptive comfort, PMV contours, PMV-based ASHRAE 55 / EN
